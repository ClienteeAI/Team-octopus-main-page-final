...
description: Provides the single source of truth for brand guidelines, design tokens, technology choices, and voice/tone for Octopus. Use this skill whenever generating UI components, styling applications, writing copy, or creating user-facing assets to ensure brand consistency.
---
...
This skill defines the core constraints for visual design and technical implementation for Octopus. You must adhere to these guidelines strictly to maintain consistency.
